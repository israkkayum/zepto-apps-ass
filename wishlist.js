document.addEventListener("DOMContentLoaded", function () {
  ...
  async function fetchBooksByIds() {
    if (wishlist.length === 0) {
      displayWishlistBooks([]); // Display empty state if no books in wishlist
      return;
    }
      ...
      div.innerHTML = `
        ...
        book.title
              ...
              <div class="card-footer-container">
                ...
                <div>
                  <span class="id-view">
                    <svg class="id-view-icon" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 8.25h15m-16.5 7.5h15m-1.8-13.5-3.9 19.5m-2.1-19.5-3.9 19.5" />
                    </svg> ${book.id}
                  </span>
                  <span class="downloads">
                    <svg class="downloads-icon" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
